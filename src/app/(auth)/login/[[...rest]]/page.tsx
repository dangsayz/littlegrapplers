      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-20">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[#1F2A44] mb-2">Welcome back</h1>
            <p className="text-[#1F2A44]/60">Sign in to access your dashboard</p>
          </div>
          ...
          <SignIn 
            appearance={{
              elements: {
                ...
                formButtonPrimary: 'bg-gradient-to-r from-[#2EC4B6] to-[#1FA89C] hover:opacity-90 transition-opacity',
